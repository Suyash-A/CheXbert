...
from utils import test, get_weighted_f1_weights
...
checkpoint_path = "/vol/bitbucket/sga23/msc_project/models/CheXbert/model_path/chexbert.pth"
...
list_path = "/vol/bitbucket/sga23/msc_project/data_msc_project/cheXbert/jayson"  # JSON file path

f1_weights = get_weighted_f1_weights(csv_path)
...
test_loader = DataLoader(test_dataset, batch_size=32, shuffle=False, collate_fn=collate_fn_with_labels)  # Adjust the batch size if necessary

# Call the test function
test(model, checkpoint_path, test_loader, f1_weights)
